...
public class ClSimplexSolver extends ClTableau {
    ...
    public final ClSimplexSolver addLowerBound(ClAbstractVariable v,
        ...
        ClLinearInequality cn = new ClLinearInequality(v, Op.GEQ,
    ...
    public final ClSimplexSolver addUpperBound(ClAbstractVariable v,
        ...
        ClLinearInequality cn = new ClLinearInequality(v, Op.LEQ,
    ...
    public final ClSimplexSolver removeEditVarsTo(int n)
            throws ExCLInternalError {
        try {
            for (Enumeration<ClVariable> e = _editVarMap.keys(); e
                    .hasMoreElements();) {
    ...
    public final ClSimplexSolver removeConstraint(ClConstraint cn)
        ...
        if (rowExpression(marker) == null) {
            ...
            if (exitVar == null) {
                ...
                for (Enumeration<Object> e = col.elements(); e
                        .hasMoreElements();) {
                    final ClAbstractVariable v = (ClAbstractVariable) e
                            .nextElement();
                    if (v.isRestricted()) {
    ...
    protected final void deltaEditConstant(double delta,
        ...
        for (Enumeration<Object> e = columnVars.elements(); e.hasMoreElements();) {
            final ClAbstractVariable basicVar = (ClAbstractVariable) e
                    .nextElement();
    ...
    protected final void dualOptimize() throws ExCLInternalError {
        ...
        while (!_infeasibleRows.isEmpty()) {
            ClAbstractVariable exitVar = (ClAbstractVariable) _infeasibleRows
    ...
    protected final void resetStayConstants() {
        ...
        for (int i = 0; i < _stayPlusErrorVars.size(); i++) {
            ClLinearExpression expr = rowExpression(_stayPlusErrorVars
                    .elementAt(i));
            if (expr == null)
    ...
    protected final void setExternalVariables() {
        ...
        for (Enumeration<Object> e = _externalParametricVars.elements(); e
                .hasMoreElements();) {
    ...
    private Hashtable<ClConstraint, Set> _errorVars; // map
    // ClConstraint
    // to
    // Set
    // (of ClVariable)
    ...
    private Hashtable<ClConstraint, ClAbstractVariable> _markerVars; // map
    // ClConstraint
    // to
    // ClVariable
    ...
    private Hashtable<ClVariable, ClEditInfo> _editVarMap; // map
    // ClVariable
    // to a
    // ClEditInfo

...
public class ClTests extends CL {
    ...
    public final static boolean addDelete1() throws ExCLInternalError,
        ...
        ClLinearInequality c10 = new ClLinearInequality(x, Op.LEQ, 10.0);
        ClLinearInequality c20 = new ClLinearInequality(x, Op.LEQ, 20.0);
        ...
        ClLinearInequality c10again = new ClLinearInequality(x, Op.LEQ, 10.0);
    ...
    public final static boolean casso1() throws ExCLInternalError,
        ...
        solver.addConstraint(new ClLinearInequality(x, Op.LEQ, y))
    ...
    public final static boolean inconsistent2() throws ExCLInternalError,
        ...
        try {
            ...
            solver.addConstraint(new ClLinearInequality(x, Op.GEQ, 10.0))
                    .addConstraint(new ClLinearInequality(x, Op.LEQ, 5.0));
    ...
    public final static boolean inconsistent3() throws ExCLInternalError,
        ...
        try {
            ...
            solver.addConstraint(new ClLinearInequality(w, Op.GEQ, 10.0))
                    .addConstraint(new ClLinearInequality(x, Op.GEQ, w))
                    .addConstraint(new ClLinearInequality(y, Op.GEQ, x))
                    .addConstraint(new ClLinearInequality(z, Op.GEQ, y))
                    .addConstraint(new ClLinearInequality(z, Op.GEQ, 8.0))
                    .addConstraint(new ClLinearInequality(z, Op.LEQ, 4.0));
